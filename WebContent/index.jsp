...
<body>
	<center>
			...
			<div class="form">
				<form>
					<div class="bg-info">
						<div>
							<div>
								<button style="margin-top:30px;margin-bottom:30px;" type="button" class="btn btn-danger"><s:a action="dept_list">查询员工 </s:a></button>
								<button style="margin-top:30px;margin-bottom:30px;" type="button" class="btn btn-success"><s:a action="role_addUI">雇佣员工 </s:a></button>
							</div>
						</div>
					</div>
				</form>
		...
		action="${pageContext.request.contextPath }/dept_list.action"
		method=post>
			...
			<s:iterator value="list" var="r">
				...
				<tr>
					...
					<td><s:property value="#r.Role_Dept.Dept_name"/></td>
